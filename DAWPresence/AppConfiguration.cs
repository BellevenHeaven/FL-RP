...
public class AppConfiguration
{
	...
	/// </summary>
	public string IdleText { get; set; } = "No se esta trabajando en un proyecto";
	
	/// <summary>
	/// Text to show before the project name when a project is open
	/// </summary>
	public string WorkingPrefixText { get; set; } = "Trabajando en ";
	...
	/// </summary>
	public string CustomImageKey { get; set; } = "key";
}